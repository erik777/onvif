...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" 
	...
	xmlns:axt="http://www.onvif.org/ver20/analytics/rules" 
	xmlns:wsnt="http://docs.oasis-open.org/wsn/b-2" targetNamespace="http://www.onvif.org/ver10/schema" elementFormDefault="qualified" version="21.06">
	...
	<!--===================================-->
	<!-- Added to support motion detection -->
	<!--===================================-->
	<xs:import namespace="http://www.onvif.org/ver20/analytics" schemaLocation="../../ver20/analytics/rules.xsd"/>
